    ...
    <div class="container">
        ...
        <div class="site-header__menu group">
            <nav class="main-navigation">
				...
				//                        ?>
                <ul>
                    <li <?php if ( is_page( 'about-us' ) || wp_get_post_parent_id( 0 ) === 14 ) {
						echo 'class="current-menu-item"';
					} ?>><a href="<?= site_url( '/about-us' ) ?>">About Us</a></li>
                    <li <?php if ( get_post_type() == 'program' )
						echo 'class="current-menu-item"' ?>><a href="<?= get_post_type_archive_link( 'program' ) ?>">Programs</a>
                    </li>
